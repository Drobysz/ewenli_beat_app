...
export const PriceTag = ({priceState, setPriceState}: PriceTagProps)=> {
    ...
    return (
        <div className="flex gap-5 max-[610px]:gap-2 items-end mb-10 max-[610px]:mb-5 pl-12 max-[1200px]:pl-0 max-[1200px]:justify-center max-[380px]:items-center max-[380px]:mb-2">
            <h2 className="text-white text-4xl max-[580px]:text-2xl max-[380px]:text-lg">Songs</h2>
            ...
            >
                <h3 className="text-2xl max-[580px]:text-lg max-[380px]:text-sm">Price</h3>

                <Image 
                    className={cn('bg-gold rounded-full transition-all duration-200 max-[580px]:w-[15px] max-[580px]:h-[15px]', {
