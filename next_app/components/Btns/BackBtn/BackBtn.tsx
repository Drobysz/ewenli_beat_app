    ...
    return (
        <motion.div 
            className={cn(
                ...
                "bg-gradient-to-br from-zinc-800/30 to-zinc-950/30",
                "text-zinc-50 transition-all duration-1600 before:absolute",
                "before:inset-0 before:-z-10 before:translate-x-[200%]",
                "before:scale-[2.5] before:rounded-[100%] before:bg-zinc-100",
                "before:transition-transform before:duration-1000",
                "hover:text-zinc-900 hover:before:translate-x-0",
                "active:scale-95 py-3 overflow-hidden",
                className)}
            onClick={()=> router.back()}
        >
